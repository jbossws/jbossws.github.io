...
## Git Setup
To contribute, you first need to fork the [jbossws.github.io](https://github.com/jbossws/jbossws.github.io) repository.
...
```
To pull update from the jbossws.github.io upstream, the jbossws.github.io remote can be added to your local git repo :
```
git remote add upstream https://github.com/jbossws/jbossws.github.io.git
```
Before change/fix, always pull update from jbossws.github.io:
```
$ git checkout -f main
